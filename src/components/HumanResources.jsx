...
const HumanResources = () => {
  return (
    <div className="HumanResources-wrapper">
      <div id="banner-area">
        ...
        <div className="container">
          <div className="team">
            ...
            >
              ...
              <p>
                Chatbots in HR are redefining the employee experiences. This
                phenomenon is taking place across various areas of HR.
                Recruitment and Onboarding, especially are seeing a lot of
                advancements in usage. Benefits, vacation policies, profile
                look-ups and training are also benefiting from them.{" "}
              </p>
              <p>
                Providing HR support 24x7 is a key benefit of chatbots.
                Answering common questions may sound simple but provides big
                productivity gains. Key capabilities include:
              </p>
              <ul className="check-list">
                <li>
                  <i className="fa fa-check"></i> Hiring at scale and fast{" "}
                </li>
                <li>
                  <i className="fa fa-check"></i> Self service in On-boarding{" "}
                </li>
                <li>
                  <i className="fa fa-check"></i> Understanding complex
                ...
                <li>
                  <i className="fa fa-check"></i> Pulse Surveys{" "}
                </li>
                <li>
                  <i className="fa fa-check"></i> Increased Employee engagement{" "}
                </li>
                <li>
                  <i className="fa fa-check"></i> Multi-lingual HR Support{" "}
                </li>
              </ul>
            </div>
          </div>
